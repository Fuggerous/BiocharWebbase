...
const stats = [
  { icon: Database,    value: recordCount,           label: 'Data Points',           color: 'text-green-500',  bg: 'bg-green-500/10 border-green-500/20' },
  { icon: Brain,       value: String(biomassCount),  label: 'Biomass Species',        color: 'text-blue-500',   bg: 'bg-blue-500/10 border-blue-500/20' },
  { icon: FlaskConical,value: String(activatorCount),label: 'Activation Methods',     color: 'text-purple-500', bg: 'bg-purple-500/10 border-purple-500/20' },
  { icon: Beaker,      value: String(TOTAL_EXPERIMENTS), label: 'Unique Experiments', color: 'text-amber-500',  bg: 'bg-amber-500/10 border-amber-500/20' },
  { icon: TrendingUp,  value: maxCO2,                label: 'Max mmol/g Recorded',   color: 'text-cyan-500',   bg: 'bg-cyan-500/10 border-cyan-500/20' },
  { icon: Award,       value: '6',                   label: 'Activator Types',        color: 'text-rose-500',   bg: 'bg-rose-500/10 border-rose-500/20' },
];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-space font-bold text-3xl lg:text-4xl text-foreground">
            Powering Global <span className="text-gradient-green">Carbon Research</span>
          </h2>
          <p className="mt-3 text-muted-foreground text-lg max-w-2xl mx-auto">
            The most comprehensive biochar CO₂ adsorption database, driven by open science and AI.
          </p>
        </motion.div>
